...
function affiche2() {
    let nbre2 = 3;
    console.log(`Donne affiche2 : nbre2 = ${nbre2}`);
    console.log(`Donne affiche 2 : nbre1 = ${nbre1}`);
}
affiche2();
...
function affiche1() {
    console.log(`Donne affiche1 : nbre1 = ${nbre1}`)
}
function affiche2() {
    let nbre2 = 3;
    console.log(`Donne affiche2 : nbre2 = ${nbre2}`);
    console.log(`Donne affiche2 : nbre1 = ${nbre1}`);
}
affiche1()
affiche2();
